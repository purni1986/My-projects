...
drop table gv_food
delete from gv_food
delete from gv_food_log
drop table gv_food_log
create table gv_food
(
...
SELECT dateof + time_end::TIME AS new_time_end FROM foodlog;

ALTER TABLE gv_food
ALTER COLUMN time_end TYPE TIMESTAMP WITHOUT TIME ZONE
USING (dateof + time_end::TIME);

ALTER TABLE gv_food drop column time_begin

select * from gv_foods
select * from gv_food_log

ALTER TABLE gv_food_log drop column patientid

ALTER TABLE gv_food_log drop column searched_food
ALTER table gv_food_log rename to gv_food
ALTER table gv_foods rename to gv_food